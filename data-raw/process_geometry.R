...
usethis::use_data(wi_tracts, overwrite = TRUE)

carpc_region <- wi_tracts %>%
  group_by(COUNTYFP) %>%
  summarise(geometry = sf::st_union(geometry))
usethis::use_data(carpc_region, overwrite = TRUE)
