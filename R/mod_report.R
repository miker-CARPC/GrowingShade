        ...
        paste0(
          if (geo_selections$selected_geo == "tracts") {
            paste0(
              ...
              "% in 2017. Compared to other block groups across the region, the tree canopy in the selected block group is ",
            ...
            paste0(
              ...
              "% in 2017. Compared to other ", if (geo_selections$selected_geo == "ctus") {
