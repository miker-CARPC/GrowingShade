...
HTML("<h2><section style='font-size:20pt'>Geography</h2>"),
    radioButtons(
      ...
      choices = c(
        "Cities, villages, and towns" = "ctus",
...
fluidRow(column(width = 6,
      ...
      shinyWidgets::pickerInput(ns("cityInput"),
        label = shiny::HTML(paste0("<h3><span style='font-size:14pt'>Pick a city, village, or town</span></h3>")),
        choices = ctu_list$GEO_NAME,
        options = list(
          title = "Pick a city, village, or town", size = 10,
          `live-search` = TRUE
        ),
        multiple = F,
        selected = "Madison"
