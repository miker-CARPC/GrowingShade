...
app_ui <- function(request) {
  ...
  tagList(
    ...
    # tags$head(img(src = "www.capitalarearpc.org/wp-content/uploads/2020/10/carpc_logo.svg", height = "60px", alt = "CARPC logo")), #,'.navbar-brand{display:none;}')),
    navbarPage(
      title = div(style = "align:center",
        a(href = "https://www.capitalarearpc.org/", target = "_blank", 
          img(src = "https://www.capitalarearpc.org/wp-content/uploads/2020/10/carpc_logo.svg", alt = "CARPC logo",
...
#                  .noWS = "outside",
#                  target = "_blank"),
                  " for help. Customize and create reports using the options below. Zoom in, or turn on the tree layer, to explore the tree canopy in year 2017."
              ),
