...
"
    ...
    radioButtons(ns("preset"),
      ...
      # radioTooltip(ns("preset"), choice = "Climate change", title = "Amount of greenspace (non-agricultural),<br> temperature on a hot summer day, tree canopy coverage in 2017, share of developed acres in a primary flood zone.", placement = "bottom", trigger = "hover"),
